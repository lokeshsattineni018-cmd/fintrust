...
export function ActivityPage() {
  ...
  return (
    ...
    >
      <motion.div variants={fadeUp}>
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-zinc-100 rounded-full border border-zinc-200 shadow-[inset_0_1px_1px_rgba(0,0,0,0.02)]">
            ...
            <h1 className="text-5xl font-bold tracking-tight text-zinc-900 font-display leading-none">Journal.</h1>
          ...
          <div className="flex gap-4">
            <motion.button
              ...
              whileTap={{ scale: 0.96 }}
              onClick={exportCSV}
              className="px-6 py-3.5 rounded-2xl border border-zinc-200 bg-white text-[13px] font-bold text-zinc-600 hover:bg-zinc-50 flex items-center gap-2.5 transition-all shadow-sm"
            >
            ...
            {role === 'admin' && (
              <motion.button
                ...
                className="bg-zinc-900 px-6 py-3.5 rounded-2xl text-[13px] font-bold text-white hover:bg-zinc-800 flex items-center gap-2.5 shadow-2xl shadow-zinc-900/20 transition-all border border-zinc-950"
              >
      ...
      >
        {[
          { label: 'Event volume', value: transactions.length, valClass: 'text-zinc-900', sub: 'Total records' },
          ...
          >
             <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-zinc-400 mb-2 group-hover:text-zinc-900 transition-colors">{stat.label}</p>
